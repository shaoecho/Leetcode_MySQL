...
![img](https://mmbiz.qpic.cn/mmbiz_png/bURPjgFpGMToFkBqedsvalm7svL2YgjTRtDbjRNY3ichYXpjticP3rW4WibPD02rKfuEeLzXynfwjibvbjOib5WaDmA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_png/bURPjgFpGMToFkBqedsvalm7svL2YgjT8D1zcEZ3Y9fUVLe6C49lnp88Uc9qqgWHrLkmNOKyzs5J6Eqj1XH0iaQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz/bURPjgFpGMToFkBqedsvalm7svL2YgjTLdZMIu791pekG0aqcgH45hhyWkKKA8dibL0lH0wVxgVcyuUosqDo4Yg/640?wx_fmt=other&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz/bURPjgFpGMToFkBqedsvalm7svL2YgjTDN7wAJQ7GZzGicyAEBbu5g1rxSggDJJRF2fawFt0icpdDnqbBSNqydSw/640?wx_fmt=other&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_png/bURPjgFpGMToFkBqedsvalm7svL2YgjTccFsGG55dvBs9z2Hwg3L2Ct0feficy87oVVXDRGk3P677uPkok1ZXFg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
- B+树的叶子节点有一条链相连，而B树的叶子节点各自独立。
  ...
  ![img](https://mmbiz.qpic.cn/mmbiz_jpg/bURPjgFpGMToFkBqedsvalm7svL2YgjTvlOuMB4uTAaJsibWv1OWBJttGxFCvhp0jiboj6JUSU3P6zMib8ybhse7w/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
1. 垂直分区：
   ...
   ![img](https://mmbiz.qpic.cn/mmbiz_jpg/bURPjgFpGMToFkBqedsvalm7svL2YgjT5vb5KwUAYIh5DIAozhV3W1T0ubBwZAtM8cVrp0xVJUO4K4KpBBnFlg/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
   ...
   ![img](https://mmbiz.qpic.cn/mmbiz_jpg/bURPjgFpGMToFkBqedsvalm7svL2YgjT6Ya2AgibEiaFRXVWWdXg6ZFrUKELO9KorIl1qLzEom7wicGoA1W5DYZ7A/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
5. - 客户端代理：分片逻辑在应用端，封装在jar包中，通过修改或者封装JDBC层来实现。当当网的 Sharding-JDBC 、阿里的TDDL是两种比较常用的实现。
   - 中间件代理：在应用和数据中间加了一个代理层。分片逻辑统一维护在中间件服务中。我们现在谈的 Mycat 、360的Atlas、网易的DDB等等都是这种架构的实现。

6. - 1、给应用增加复杂度，通常查询时需要多个表名，查询所有数据都需UNION操作
   - 2、在许多数据库应用中，这种复杂度会超过它带来的优点，查询时会增加读一个索引层的磁盘次数

7. - 1、表中的数据本身就有独立性，例如表中分表记录各个地区的数据或者不同时期的数据，特别是有些数据常用，有些不常用。
   - 2、需要把数据存放在多个介质上。
...
- 跨分片的排序分页
  ...
  ![img](https://mmbiz.qpic.cn/mmbiz_png/bURPjgFpGMToFkBqedsvalm7svL2YgjTAQYxpzAfVMve5PrbIWd31Y1JkYEEl9SRbLatVS5XntmshctPuq73Xw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_jpg/bURPjgFpGMToFkBqedsvalm7svL2YgjTTjtoYcxiaGMZNiatxdGsNnCpMiaiaEpmNXzVD9J6GoDfa1XZ9v08kKFxeA/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
